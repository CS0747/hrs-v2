...
-- Dashboard
('Dashboard','DIOS','View',0),('Dashboard','Super Admin','View',1),('Dashboard','Admin','View',1),('Dashboard','Section Admin','View',1),
-- Employee Masterlist
('Employee Masterlist','DIOS','View',0),('Employee Masterlist','DIOS','Add',0),('Employee Masterlist','DIOS','Edit',0),('Employee Masterlist','DIOS','Delete',0),('Employee Masterlist','DIOS','Export',0),
...
-- DTR Transmittal
('DTR Transmittal','DIOS','View',0),('DTR Transmittal','DIOS','Add',0),('DTR Transmittal','DIOS','Edit',0),('DTR Transmittal','DIOS','Delete',0),('DTR Transmittal','DIOS','Verify',0),('DTR Transmittal','DIOS','Export',0),
...
-- Leave Management
('Leave Management','DIOS','View',0),('Leave Management','DIOS','Add',0),('Leave Management','DIOS','Edit',0),('Leave Management','DIOS','Delete',0),('Leave Management','DIOS','Approve',0),
...
-- Travel Orders
('Travel Orders','DIOS','View',0),('Travel Orders','DIOS','Add',0),('Travel Orders','DIOS','Edit',0),('Travel Orders','DIOS','Delete',0),('Travel Orders','DIOS','Approve',0),
...
-- Schedule Database
('Schedule Database','DIOS','View',0),('Schedule Database','DIOS','Add',0),('Schedule Database','DIOS','Edit',0),('Schedule Database','DIOS','Delete',0),('Schedule Database','DIOS','Export',0),
...
-- Trainings
('Trainings','DIOS','View',0),('Trainings','DIOS','Add',0),('Trainings','DIOS','Edit',0),('Trainings','DIOS','Delete',0),
...
-- Tracking / Receiving
('Tracking / Receiving','DIOS','View',0),('Tracking / Receiving','DIOS','Add',0),('Tracking / Receiving','DIOS','Edit',0),('Tracking / Receiving','DIOS','Delete',0),
...
-- Audit History
('Audit History','DIOS','View',0),('Audit History','DIOS','Export',0),
...
-- DIOS Account
('DIOS Account','DIOS','View',0),('DIOS Account','DIOS','Add',0),('DIOS Account','DIOS','Edit',0),('DIOS Account','DIOS','Delete',0),
...
-- Version History
('Version History','DIOS','View',0),('Version History','DIOS','Export',0),
...
-- User Manual
('User Manual','DIOS','View',0),('User Manual','Super Admin','View',1),('User Manual','Admin','View',1),('User Manual','Section Admin','View',1),
-- Birthday Celebrants
('Birthday Celebrants','DIOS','View',0),('Birthday Celebrants','DIOS','Export',0),
...
-- AI Scanning Tools
('AI Scanning Tools','DIOS','View',0),('AI Scanning Tools','DIOS','Upload',0),('AI Scanning Tools','DIOS','Delete',0),
...
-- Audit Transmittal
('Audit Transmittal','DIOS','View',0),('Audit Transmittal','DIOS','Export',0),
